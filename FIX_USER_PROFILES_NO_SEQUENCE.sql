-- =====================================================
-- SCRIPT PERBAIKAN USER_PROFILES (TANPA SEQUENCE ERROR)
-- =====================================================
-- Jalankan script ini untuk memperbaiki masalah sequence
...
-- =====================================================
-- 5. GRANT PERMISSIONS (TANPA SEQUENCE)
-- =====================================================

-- Grant permissions untuk authenticated users
GRANT SELECT, INSERT, UPDATE ON public.user_profiles TO authenticated;

-- CATATAN: user_profiles menggunakan UUID, bukan BIGSERIAL
-- Jadi TIDAK ADA SEQUENCE yang perlu di-grant
...
BEGIN
    ...
    RAISE NOTICE 'Primary Key: UUID (no sequence needed)';
    RAISE NOTICE '';
    RAISE NOTICE 'Features enabled:';
    RAISE NOTICE '- UUID primary key (gen_random_uuid)';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'No sequence error - UUID primary key used!';
END $$;